...
<body>
    <form method="post" action="/customer/handle-register">
        ...
        <div class="inputGroup inputGroup1">
            <label for="loginPhone" id="loginPhoneLabel">Email</label>
            <input type="text" name="email" id="loginPhone" maxlength="254" required />
        </div>
