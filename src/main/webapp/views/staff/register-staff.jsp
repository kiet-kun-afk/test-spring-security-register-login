...
<body>
    <form method="post" action="/staff/handle-register">
        ...
        <div class="inputGroup inputGroup1">
            <label for="loginPhone" id="loginPhoneLabel">Username</label>
            <input type="text" name="username" id="loginPhone" maxlength="254" required/>
        </div>
        <div class="inputGroup inputGroup2">
            <label for="loginPassword" id="loginPasswordLabel">Password</label>
            <input type="password" name="password" id="loginPassword" pattern=".{8,}" title="Eight or more characters" required/>
        ...
        <div class="inputGroup inputGroup2">
            ...
            <input type="radio" name="role" id="role" value="staff" />STAFF
        </div>
	...
	<div>
		...
		<div>
			...
			<input type="text" name="captcha" id="captcha" value="${captcha}" pattern=".{5,}" title="Five or more characters" required required/>
		</div>
	</div>
    <br>
